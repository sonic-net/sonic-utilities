...
class MellanoxBufferMigrator():
    ...
    def mlnx_flush_new_buffer_configuration(self):
        ...
        use_traditional = (not self.is_buffer_config_default and not self.is_buffer_config_empty
                           or self.is_default_traditional_model)

        if use_traditional and not already_dynamic:
