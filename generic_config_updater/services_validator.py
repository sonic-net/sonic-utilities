...
def command_wrapper(command):
    """
    Wrapper for executing a command
    This function checks if the environment variable 'CONTAINER_NAME' is set,
    and if so, it modifies the command to run in the container.
    """
    if 'CONTAINER_NAME' in os.environ and "systemctl" in command:
