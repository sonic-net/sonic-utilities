...
class TestShow(object):
    ...
    def test_show_arp(self, mock_run_command):
        ...
        assert result.exit_code == 0
        mock_run_command.assert_called_with(['nbrshow', '-4', '-ip', '0.0.0.0', '-if', 'Ethernet0', '-d', 'all'], display_cmd=True)
    ...
    def test_show_ndp(self, mock_run_command):
        ...
        assert result.exit_code == 0
        mock_run_command.assert_called_with(['nbrshow', '-6', '-ip', '0.0.0.0', '-if', 'Ethernet0', '-d', 'all'], display_cmd=True)
