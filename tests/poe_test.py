...
class TestPOE:
    ...
    def test_config_and_show_poe_interface_success(self, command, value, output):
        ...
        result = runner.invoke(
            ...
            commands[command], [ETHERNET_1, value], obj=db
        )
    ...
    @pytest.mark.parametrize("intf,command,value,exit_code", [
        ...
        (ETHERNET_1, STATUS, INVALID_VALUE, ERROR2),
        (ETHERNET_1, POWER_LIMIT, INVALID_VALUE, ERROR2),
        (ETHERNET_1, PRIORITY, INVALID_VALUE, ERROR2),
        ])
