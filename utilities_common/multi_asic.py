...
def multi_asic_get_ns_list(namespace=None):
    ...
    if namespace and namespace != constants.DEFAULT_NAMESPACE and namespace not in multi_asic.get_namespace_list():
...
def get_namespace_from_ctx():
    ...
    Returns None if no namespace is found (e.g., invoked directly in tests).
    """
    _sentinel = object()
